<?php
	...
	if (!$conn) {
		...
		$JobReferenceNumber = $_POST["JRN"];
		$sql_table="Applicant_Details";
		$query = "DELETE FROM $sql_table WHERE Job_Reference_Number LIKE '$JobReferenceNumber%'";
		$result = mysqli_query($conn, $query);
		
		if (!$result){
			echo "<p>There are no current applications for this job to delete !</p>";			
		}
		else {
		...
		echo "<p>Please enter Job Reference Number to delete from table !</p>";
	}
?> 
</body>
</html>