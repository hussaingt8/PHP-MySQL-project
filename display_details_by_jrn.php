<?php
	...
	if (!$conn) {
	...
	else if ($_POST["JobReferenceNumber"] != ""){
			
		$JobReferenceNumber = $_POST["JobReferenceNumber"];
		$sql_table="Applicant_Details";
		$query = "SELECT * FROM $sql_table WHERE Job_Reference_Number LIKE '$JobReferenceNumber%'";
		...
		echo "<p>Please enter Job Reference Number to search !</p>";
	}
?> 
</body>
</html>